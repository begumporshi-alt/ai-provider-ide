...
| Tests | **460** TS unit (18 adapter-spec · 249 router-core · 193 desktop) · **27** end-to-end · **104** browser · **812** Rust | Browser and Rust re-measured 2026-09-23 after 0017 (+6 and +8); TS unit unchanged. Rust re-measured 2026-09-24 at **812** after increments 11b–15 (489 → 812: planner +29, ledger +16, router +50, compression +34, adapter interpretation +66, and the rest across `engine.rs`, `pricing.rs` and the 0017 work) |
