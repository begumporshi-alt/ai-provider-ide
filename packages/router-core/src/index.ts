...
export interface HttpPort {
  ...
  request(req: {
    ...
    secretRef?: string;
    signal?: AbortSignal;
  }): Promise<{ status: number; headers: Record<string, string>; text: () => Promise<string>; lines: AsyncIterable<string> }>;
}
...
export interface RouterFacade {
  generateText(req: TextRequest, opts?: { signal?: AbortSignal }): Promise<AsyncIterable<TextChunk>>;
