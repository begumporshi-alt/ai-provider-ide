...
| Tests | **460** TS unit (18 adapter-spec · 249 router-core · 193 desktop) · **27** end-to-end · **104** browser · **746** Rust | Browser and Rust re-measured 2026-09-23 after 0017 (+6 and +8); TS unit unchanged. Rust re-measured 2026-09-24 at **746** after increments 11b–14a (489 → 746: planner +29, ledger +16, router +50, compression +34, and the rest across `engine.rs`, `pricing.rs` and the 0017 work) |
